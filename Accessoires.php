...
$totalQuery = "SELECT COUNT(*) AS total FROM products WHERE category = 'Accessoires'";
...
$Accessoires_query = "SELECT id, name, image_url, description, price, rating, specs_cpu, specs_gpu, specs_ram, specs_storage
               FROM products 
               WHERE category = 'Accessoires' 
               ORDER BY price ASC 
               LIMIT $productsPerPage OFFSET $offset";

$Accessoires_result = mysqli_query($conn, $Accessoires_query);

$page_title = "Accessoires | SuNNNyTech";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="breadcrumb" style="display: flex; justify-content: center; align-items: center; gap: 5px; position: relative; bottom: 650px; margin-top: 20px;">
    ...
    <aside class="sidebar">
        ...
        <h3 style="margin-top: 40px;">Accessories</h3>
        <label><input type="checkbox" name="accessories[]" value="monitor" /> Monitor</label>
        <label><input type="checkbox" name="accessories[]" value="keybord" /> Keybord</label>
    ...
    <section class="main-content">
        ...
        <div class="product-list">
            <?php if (mysqli_num_rows($Accessoires_result) > 0): ?>
                <?php while ($product = mysqli_fetch_assoc($Accessoires_result)): ?>
