...
$totalQuery = "SELECT COUNT(*) AS total FROM products WHERE category = 'Motherbords'";
...
$Motherbords_query = "SELECT id, name, image_url, description, price, rating, specs_cpu, specs_gpu, specs_ram, specs_storage
               FROM products 
               WHERE category = 'Motherbords' 
               ORDER BY price ASC 
               LIMIT $productsPerPage OFFSET $offset";

$Motherbords_result = mysqli_query($conn, $Motherbords_query);

$page_title = "Motherbord's | SuNNNyTech";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="breadcrumb" style="display: flex; justify-content: center; align-items: center; gap: 5px; position: relative; bottom: 650px; margin-top: 20px;">
    ...
    <aside class="sidebar">
        ...
        <label><input type="checkbox" name="Motherbords[]" value="assus" /> Assus</label>
        <label><input type="checkbox" name="Motherbords[]" value="msi" /> MSI</label>
        <label><input type="checkbox" name="Motherbords[]" value="hp" /> HP</label>
        <label><input type="checkbox" name="Motherbords[]" value="gigabyte" /> Gigabyte</label>
    ...
    <section class="main-content">
        ...
        <div class="product-list">
            <?php if (mysqli_num_rows($Motherbords_result) > 0): ?>
                <?php while ($product = mysqli_fetch_assoc($Motherbords_result)): ?>
