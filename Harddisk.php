...
$totalQuery = "SELECT COUNT(*) AS total FROM products WHERE category = 'Harddisks'";
...
$Harddisks_query = "SELECT id, name, image_url, price, rating, specs_cpu, specs_gpu, specs_ram, specs_storage 
               FROM products 
               WHERE category = 'Harddisks' 
               ORDER BY price ASC 
               LIMIT $productsPerPage OFFSET $offset";

$Harddisks_result = mysqli_query($conn, $Harddisks_query);

$page_title = "Hard Disk's | SuNNNyTech";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="breadcrumb" style="display: flex; justify-content: center; align-items: center; gap: 5px; position: relative; bottom: 650px; margin-top: 20px;">
    ...
    <section class="main-content">
        ...
        <div class="product-list">
            <?php if (mysqli_num_rows($Harddisks_result) > 0): ?>
                <?php while ($product = mysqli_fetch_assoc($Harddisks_result)): ?>
