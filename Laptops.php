...
$totalQuery = "SELECT COUNT(*) AS total FROM products WHERE category = 'Laptops'";
...
$Laptops_query = "SELECT id, name, image_url, price, rating, specs_cpu, specs_gpu, specs_ram, specs_storage 
               FROM products 
...
$page_title = "Laptop's | SuNNNyTech";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    ...
    <section class="main-content">
        ...
        <div class="product-list">
            <?php if (mysqli_num_rows($Laptops_result) > 0): ?>
                <?php while ($product = mysqli_fetch_assoc($Laptops_result)): ?>
