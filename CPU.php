...
$totalQuery = "SELECT COUNT(*) AS total FROM products WHERE category = 'CPUs'";
...
$CPUs_query = "SELECT id, name, image_url, description, price, rating, specs_cpu, specs_gpu, specs_ram, specs_storage
               FROM products 
               WHERE category = 'CPUs' 
               ORDER BY price ASC 
               LIMIT $productsPerPage OFFSET $offset";

$CPUs_result = mysqli_query($conn, $CPUs_query);

$page_title = "CPU's | SuNNNyTech";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="breadcrumb" style="display: flex; justify-content: center; align-items: center; gap: 5px; position: relative; bottom: 650px; margin-top: 20px;">
    ...
    <section class="main-content">
        ...
        <div class="product-list">
            <?php if (mysqli_num_rows($CPUs_result) > 0): ?>
                <?php while ($product = mysqli_fetch_assoc($CPUs_result)): ?>
