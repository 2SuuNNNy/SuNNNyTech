...
$totalQuery = "SELECT COUNT(*) AS total FROM products WHERE category = 'GPUs'";
...
$GPUs_query = "SELECT id, name, image_url, price, rating, specs_cpu, specs_gpu, specs_ram, specs_storage 
               FROM products 
               WHERE category = 'GPUs' 
               ORDER BY price ASC 
               LIMIT $productsPerPage OFFSET $offset";

$CPUs_result = mysqli_query($conn, $GPUs_query);

$page_title = "GPU's | SuNNNyTech";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="breadcrumb" style="display: flex; justify-content: center; align-items: center; gap: 5px; position: relative; bottom: 650px; margin-top: 20px;">
    ...
    <section class="main-content">
        ...
        <div class="product-list">
            <?php if (mysqli_num_rows($GPUs_result) > 0): ?>
                <?php while ($product = mysqli_fetch_assoc($GPUs_result)): ?>
